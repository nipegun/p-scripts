    ...
    # Ejecutar comandos específicos dependiendo del número seleccionado
      case "$vNumTarjeta" in
        ...
        1)
          ...
          echo "lxc.idmap: g 0 100000 $vNumGrupoVideoDelHost"
          echo "lxc.idmap: g $vNumGrupoVideoDelLXC $vNumGrupoVideoDelHost 1"
          echo "lxc.idmap: g 45 100045 62"
          echo "lxc.idmap: g $vNumGrupoRenderDelLXC $vNumGrupoRenderDelHost 1"
