...
#------------------------------------------------------------------------------------------------
#  Script de NiPeGun para resetear el minero de Crypton instalado en un container LXC de Debian
#------------------------------------------------------------------------------------------------
...
if [ $OS_VERS == "7" ]; then
  ...
  echo ""
  echo "----------------------------------------------------------------------------------------------------"
  echo "  Iniciando el script para resetear el minero de Crypton del container LXC de Debian 7 (Wheezy)..."
  echo "----------------------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "----------------------------------------------------------------------------------------------------"
  echo "  Iniciando el script para resetear el minero de Crypton del container LXC de Debian 8 (Jessie)..."
  echo "----------------------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-----------------------------------------------------------------------------------------------------"
  echo "  Iniciando el script para resetear el minero de Crypton del container LXC de Debian 9 (Stretch)..."
  echo "-----------------------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-----------------------------------------------------------------------------------------------------"
  echo "  Iniciando el script para resetear el minero de Crypton del container LXC de Debian 10 (Buster)..."
  echo "-----------------------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-------------------------------------------------------------------------------------------------------"
  echo "  Iniciando el script para resetear el minero de Crypton del container LXC de Debian 11 (Bullseye)..."
  echo "-------------------------------------------------------------------------------------------------------"
  echo ""
  ...
  ## Hacer copia de seguridad del archio uam.ini
     mv /home/minerocrp/.uam/uam.ini /home/minerocrp/

  ## Borrar todos los datos del anterior minero
     rm -rf /home/minerocrp/.uam/*

  ## Modificar el archivo uam.ini para adaptarlo al nuevo minero
     IPYPuerto=$(cat /home/minerocrp/uam.ini | grep listens)
     echo "[net]"     > /home/minerocrp/uam.ini
     echo $IPYPuerto >> /home/minerocrp/uam.ini
     
  ## Mover el archivo uam.ini a su ubicación final
     mv /home/minerocrp/uam.ini /home/minerocrp/.uam/
