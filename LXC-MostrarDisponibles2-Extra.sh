...
## Debian
   ...
   sed -i "s/^/$URLBase/g" /tmp/lxc-debian.txt
   echo ""
...
## Devuan
   ...
   sed -i "s/^/$URLBase/g" /tmp/lxc-devuan.txt
   echo ""
...
## Kali
   ...
   sed -i "s/^/$URLBase/g" /tmp/lxc-kali.txt
   echo ""
...
## OpenWRT
   ...
   sed -i "s/^/$URLBase/g" /tmp/lxc-openwrt.txt
   echo ""
...
## Ubuntu
   ...
   sed -i "s/^/$URLBase/g" /tmp/lxc-ubuntu.txt
   echo ""
