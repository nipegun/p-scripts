...
vSupports_v2-AES='awk "/cx16/&&/lahf_lm/&&/pni/&&/popcnt/&&/sse4_1/&&/sse4_2/&&/ssse3/&&/aes/ {found=1} END {exit !found}"'
...
echo "$vFlags" | eval $vSupports_v2 || exit 3 && echo "Se puede usar: x86-64-v2-AES"
