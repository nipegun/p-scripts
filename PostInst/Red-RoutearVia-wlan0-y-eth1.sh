...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación para que ProxmoxVE 3 routee por wlan0 y eth1..."
  echo "--------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación para que ProxmoxVE 4 routee por wlan0 y eth1..."
  echo "--------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación para que ProxmoxVE 5 routee por wlan0 y eth1..."
  echo "--------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación para que ProxmoxVE 6 routee por wlan0 y eth1..."
  echo "--------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación para que ProxmoxVE 7 routee por wlan0 y eth1..."
  echo "--------------------------------------------------------------------------------------"
  echo ""
