...
if [ $OS_VERS == "7" ]; then
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 3...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 4...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 5...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 6...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 7...${vFinColor}"
  echo ""

  echo ""
  echo -e "${cColorRojo}    Comandos para Proxmox 7 todavía no preparados. Prueba ejecutarlo en otra versión de Proxmox.${vFinColor}"
  echo ""
