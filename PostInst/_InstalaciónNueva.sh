...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 3...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 4...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 5...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 6...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de xxxxxxxxx para ProxmoxVE 7...${cFinColor}"
  echo ""
