...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de post-instalación para ProxmoxVE 3...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de post-instalación para ProxmoxVE 4...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de post-instalación para ProxmoxVE 5...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de post-instalación para ProxmoxVE 6...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de post-instalación para ProxmoxVE 7...${cFinColor}"
  echo ""
  ...
  # Si no existe el archivo /root/Fase1Comp.txt
    if [ ! -f /root/Fase1Comp.txt ]; then
      ...
      # Activar IOMMU
        ...
        # Modificar /etc/default/grub según arquitectura
          if [ vArquitect == "Intel" ]; then
            ...
            echo ""
            echo -e "${cColorRojo}    No se pudo activar IOMMU en grub porque no se pudo determinar la arquitectura del procesador.${cFinColor}"
            echo ""
          fi
      ...
      # Notificar fin de fase 1
        echo ""
        echo -e "${cColorVerde}    Fase 1 del script completada.${cFinColor}"
        echo -e "${cColorVerde}    La siguiente vez que ejecutes el script se ejecutará la fase 2.${cFinColor}"
        echo ""
  ...
  # Si no existe el archivo /root/Fase2Comp.txt
    if [ ! -f /root/Fase2Comp.txt ]; then
      ...
      # Notificar fin de fase 2
        echo ""
        echo -e "${cColorVerde}    Fase 2 del script completada.${cFinColor}"
        echo -e "${cColorVerde}    La siguiente vez que ejecutes el script se ejecutará la fase 3.${cFinColor}"
        echo ""
  ...
  # Si no existe el archivo /root/Fase3Comp.txt
    if [ ! -f /root/Fase3Comp.txt ]; then
      ...
      # Notificar fin de fase 3
        echo ""
        echo -e "${cColorVerde}    Fase 3 del script completada.${cFinColor}"
        echo -e "${cColorVerde}    La siguiente vez que ejecutes el script se ejecutará la fase 4.${cFinColor}"
        echo ""
  ...
  # Si no existe el archivo /root/Fase4Comp.txt
    if [ ! -f /root/Fase4Comp.txt ]; then
      ...
      # Notificar fin de fase 4
        echo ""
        echo -e "${cColorVerde}    Fase 4 del script completada.${cFinColor}"
        echo -e "${cColorVerde}    La siguiente vez que ejecutes el script se ejecutará la fase 5.${cFinColor}"
        echo ""
